    ...
    function handleCheckout() {
        fetch(`${window.location.origin}/api/checkout`, {
            ...
            body: JSON.stringify({
                ...
                billing: props.router.query.billing, 
                payment: props.router.query.payment, 
                address: props.router.query.address, 
                fullName: props.router.query.fullName,
                cvc: props.router.query.cvc,
                date: props.router.query.date,
            }),
        })
            .then(res => {
